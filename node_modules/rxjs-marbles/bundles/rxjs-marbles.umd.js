...
(function (global, factory) {
	...
	(factory((global.rxjsMarbles = {}),global.Rx.Scheduler,global.Rx.Scheduler,global.Rx.Scheduler,global.Rx.Scheduler,global.Rx));
...
function _cases(adapter, cases) {
    if (!isArray(cases)) {
        cases = Object.keys(cases).map(function (key) { return (__assign$1({}, cases[key], { name: key })); });
    }
