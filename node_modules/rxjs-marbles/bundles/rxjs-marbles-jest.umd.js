...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs/scheduler/animationFrame'), require('rxjs/scheduler/asap'), require('rxjs/scheduler/async'), require('rxjs/scheduler/queue'), require('rxjs/testing/TestScheduler')) :
	typeof define === 'function' && define.amd ? define(['exports', 'rxjs/scheduler/animationFrame', 'rxjs/scheduler/asap', 'rxjs/scheduler/async', 'rxjs/scheduler/queue', 'rxjs/testing/TestScheduler'], factory) :
	(factory((global.rxjsMarblesJest = {}),global.Rx.Scheduler,global.Rx.Scheduler,global.Rx.Scheduler,global.Rx.Scheduler,global.Rx));
}(this, (function (exports,animationFrame,asap,async,queue,TestScheduler) { 'use strict';
...
function cases(name, func, cases) {
    describe(name, function () {
        _cases(function (c) {
            ...
            if (func.length > 2) {
                t(c.name, marbles$1(function (m, second) {
                    var rest = [];
