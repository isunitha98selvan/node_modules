/*MIT license https://github.com/cartant/rxjs-marbles/blob/master/LICENSE*/
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs/scheduler/animationFrame'), require('rxjs/scheduler/asap'), require('rxjs/scheduler/async'), require('rxjs/scheduler/queue'), require('rxjs/testing/TestScheduler'), require('ava')) :
	typeof define === 'function' && define.amd ? define(['exports', 'rxjs/scheduler/animationFrame', 'rxjs/scheduler/asap', 'rxjs/scheduler/async', 'rxjs/scheduler/queue', 'rxjs/testing/TestScheduler', 'ava'], factory) :
	(factory((global.rxjsMarblesAva = {}),global.Rx.Scheduler,global.Rx.Scheduler,global.Rx.Scheduler,global.Rx.Scheduler,global.Rx,global.unsupported));
}(this, (function (exports,animationFrame,asap,async,queue,TestScheduler,ava) { 'use strict';
...
function configure(options) {
    configuration = __assign$1({}, options);
}
function get$1(key) {
...
var Context = (function () {
    ...
    Context.prototype.bind = function () {
        ...
        if (schedulers.length === 0) {
            schedulers = [animationFrame.animationFrame, asap.asap, async.async, queue.queue];
        }
...
function marbles(func) {
    if (func.length > 1) {
        return function (first) {
            ...
            var scheduler = new TestScheduler.TestScheduler(function (a, b) { return observableMatcher(a, b, get$1("assert"), get$1("assertDeepEqual"), get$1("frameworkMatcher")); });
...
function cases(name, func, cases) {
    _cases(function (c) {
        var t = c.only ? ava.test.only : c.skip ? ava.test.skip : ava.test;
        t(name + " / " + c.name, marbles$1(function (m, t) { return func(m, c, t); }));
    }, cases);
}
function marbles$1(func) {
    return marbles(function (m, t) {
        m.configure({
